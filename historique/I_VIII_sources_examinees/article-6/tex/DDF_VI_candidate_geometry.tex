...
\begin{figure}[h]\centering\includegraphics[width=.92\textwidth]{fig_divisors_3181}
...
\begin{figure}[h]\centering\includegraphics[width=.85\textwidth]{fig_de_scales}
...
\end{tabular}
\end{center}
\begin{figure}[h]\centering\includegraphics[width=.95\textwidth]{fig_inflation}
