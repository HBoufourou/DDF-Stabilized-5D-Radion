...
\end{tabular}
\end{center}
\begin{figure}[h]\centering\includegraphics[width=.80\textwidth]{fig1_motif.png}
...
\textbf{The K3 wrapping sits at the centre of the window} ($0.451$ against $[0.30,0.61]$). \begin{figure}[h]\centering\includegraphics[width=.62\textwidth]{fig2_cone.png}
